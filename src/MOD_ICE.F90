...
!    integer                                     :: num_itracers=3
    ...
    integer                   :: whichEVP=0                ! 0 = standard EVP, 1 = modified EVP (mEVP),
                                                           ! 2 = adaptive EVP (aEVP), 3 = test_solver,
                                                           ! 4 = mEVP (CR element), 5 = mEVP (CR element, div stress)
    integer                   :: ice_vplace = 0            ! placement of sea ice velocity:
                                                           !    0 = node placement, 1 = edge placement
    real(kind=WP)             :: nc_stab = 2.5_WP          ! stabilization factor for the CR element
